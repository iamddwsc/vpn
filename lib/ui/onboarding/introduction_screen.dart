...
class IntroductionScreen extends StatefulWidget {
  ...
  final Position? customPositionSkipBtn;
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        widget.customPositionSkipBtn != null
            ? Positioned.fill(
                left: widget.customPositionSkipBtn?.left,
                top: widget.customPositionSkipBtn?.top,
                right: widget.customPositionSkipBtn?.right,
                bottom: widget.customPositionSkipBtn?.bottom,
